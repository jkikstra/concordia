...
DS_ATTRS = dict(
    ...
    comment="Gridded emissions produced after harmonization and downscaling following the method of the ScenarioMIP-CMIP7. See https://github.com/iiasa/emissions_harmonization_historical, https://github.com/IAMconsortium/concordia, and https://github.com/iiasa/aneris for documentation on the processes.",
    contact="hoegner@iiasa.ac.at, marit.sandstad@cicero.oslo.no, kikstra@iiasa.ac.at, benjamin.sanderson@cicero.oslo.no",
    data_structure="grid",
    ...
    source="pathway generated as part of the PolMIP-CMIP7 project",
    further_info_url="https://doi.org/10.5281/zenodo.21487424",
    doi="10.5281/zenodo.21487424",
    table_id="input4MIPs",
    target_mip="PolMIP",
    product="derived",
    start_date="201501",
...
def ds_attrs(name, marker_scenario_name, version, date):
    ...
    title = (
        f"Future {handle} emissions of {gas} in {marker_scenario_name}-cf"
    )
